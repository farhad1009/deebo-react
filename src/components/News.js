                    ...
                    <ul class="modal_items" data-from="blog" data-count={5}>
                        ...
                        <li>
                            ...
                            >
                                ...
                                <div class="fn__hidden">
                                    <p class="fn__cat">June 05, 2021</p>
                                    <h3 class="fn__title">How to prepare your design portfolio on Behance</h3>
                                    <div class="img_holder">
                                        <img src="img/thumb/square.jpg" alt="" />
                                        <div class="abs_img" data-bg-img="img/blog/6.jpg"></div>
                                    </div>
                        ...
                        <li className={!hiddenItem ? "" : "be_animated"}>
                            ...
                            >
                                <div class="img_wrapper">
                                    <div class="abs_img" data-bg-img="img/blog/7.jpg"></div>
                                    <img src="img/blog/tip.png" alt="" />
                                </div>
                                <p>May 12, 2021</p>
                                <h5><a href="#">A Case for Becoming More Gentle in Your Life</a></h5>
                                <div class="fn__hidden">
                                    <p class="fn__cat">May 12, 2021</p>
                                    <h3 class="fn__title">A Case for Becoming More Gentle in Your Life</h3>
                                    <div class="img_holder">
                                        <img src="img/thumb/square.jpg" alt="" />
                                        <div class="abs_img" data-bg-img="img/blog/7.jpg"></div>
                                    </div>
                        ...
                        <li className={!hiddenItem ? "" : "be_animated"}>
                            ...
                            >
                                <div class="img_wrapper">
                                    <div class="abs_img" data-bg-img="img/blog/8.jpg"></div>
                                    <img src="img/blog/tip.png" alt="" />
                                </div>
                                <p>March 23, 2021</p>
                                <h5><a href="#">When Father’s Day is Different for You</a></h5>
                                <div class="fn__hidden">
                                    <p class="fn__cat">March 23, 2021</p>
                                    <h3 class="fn__title">When Father’s Day is Different for You</h3>
                                    <div class="img_holder">
                                        <img src="img/thumb/square.jpg" alt=""/>
                                            <div class="abs_img" data-bg-img="img/blog/8.jpg"></div>
                                    </div>
